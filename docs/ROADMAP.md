...
>
> **完成证据：** `docs/specs/2026-05-13-phase6-completion-design.md` + `docs/plans/2026-05-13-phase6-completion.md` + 2 创意文档 + ctest CP+ON 175/175 + vitest 32/32。
...
本文档是 v2.0 路线图，记录 Phase 5-8 的战略与交付。后续路线已扩展为两个并行轨道：

- **AegisGate 开源核心工程路线** → 见 [ROADMAP_v3.md](ROADMAP_v3.md)（全球化 × 平台化 × 智能化 / Phase 9-14）
- **AegisOps 产品/商业化叠加路线** → 见 [ROADMAP_v4.md](ROADMAP_v4.md) · [ROADMAP_v4_zh.md](ROADMAP_v4_zh.md)（品牌升级 → 行业合规包 → SaaS 控制平面）

v2 + v3 + v4 三代路线并存：v2/v3 是工程，v4 是商业化叠加，互不取代。
