...
**最后更新：** 2026-05-20
**姊妹文档：** [合规对标](../compliance/README_zh.md) · [路线图 v4](../ROADMAP_zh.md) · [English](aegisops-vision.md)
...
> 详细里程碑在 [ROADMAP_zh.md](../ROADMAP_zh.md)，此处仅给出摘要：
...
定价细则、license 等级、商业化条款属于阶段 3 范围（见 [ROADMAP_zh.md](../ROADMAP_zh.md)
阶段 3）。当前承诺：
...
- [路线图 v4](../ROADMAP_zh.md) — 详细 5 年里程碑
